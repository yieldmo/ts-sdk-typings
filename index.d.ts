// Type definitions for YM_SDK (web-formats) Project: ts-sdk
 ...
 */
export function trackEv(type : string, startTime : string | number, eventData : any, formatWindow : PlacementWindow, creativeIds?: boolean | string[]) : void;
